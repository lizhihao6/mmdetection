...
log_level = 'INFO'
load_from = None
resume_from = 'work_dirs/yolov3_mobilenetv2_mstrain-2016_300e_asi_294mcpro/latest.pth'
workflow = [('train', 1)]
...
work_dir = './work_dirs/yolov3_mobilenetv2_mstrain-2016_300e_asi_294mcpro'
gpu_ids = range(0, 4)
