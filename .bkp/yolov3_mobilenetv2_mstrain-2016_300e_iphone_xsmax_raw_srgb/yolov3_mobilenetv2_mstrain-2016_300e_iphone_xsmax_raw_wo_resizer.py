...
train_pipeline = [
    ...
    dict(type='Rearrange'),
    dict(type='CamTosRGB'),
    dict(type='Expand', mean=[0, 0, 0], to_rgb=False, ratio_range=(1, 2)),
    dict(
...
data = dict(
    ...
    train=dict(
        ...
        dataset=dict(
            ...
            ann_file='/lzh/datasets/multiRAW/iphone_xsmax/train.txt',
            img_prefix='/lzh/datasets/multiRAW/iphone_xsmax/',
            img_subdir='raw',
    ...
    val=dict(
        type='MultiRAWDataset',
        ann_file='/lzh/datasets/multiRAW/iphone_xsmax/test.txt',
        img_prefix='/lzh/datasets/multiRAW/iphone_xsmax/',
        img_subdir='raw',
        meta_subdir='metainfo',
        ann_subdir='labels/detection',
...
work_dir = './work_dirs/yolov3_mobilenetv2_mstrain-2016_300e_iphone_xsmax_raw_wo_resizer'
gpu_ids = range(0, 4)
